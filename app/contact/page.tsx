        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl text-slate-300 leading-relaxed">
              Ready to discuss your testing requirements? Our experts are here to help you with certification,
              interoperability testing, and regulatory compliance.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 mt-1">+91-XXX-XXX-XXXX</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 mt-1">info@cnlabsglobal.com</p>
                    </div>
                  </div>
              ...
              <Card className="border-0 shadow-lg">
                <CardHeader>
                  ...
                  <CardDescription>Need specific information? Check out these resources.</CardDescription>
                </CardHeader>
                <CardContent className="space-y-3">
                  ...
                  <Button variant="outline" className="w-full justify-start" asChild>
                    <a href="/about">Learn About CNLABS</a>
                  </Button>
                </CardContent>
              </Card>
            </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <Select onValueChange={(value) => handleChange("service", value)}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="interoperability">Interoperability Testing</SelectItem>
                            <SelectItem value="third-party">3rd Party Testing</SelectItem>
                            <SelectItem value="regulatory">Regulatory Testing</SelectItem>
